        ...
        float in_aFloat, double in_aDouble, const std::string &in_aString)
{
    LOGD("[MyService] [cpp] basicTypes: int=%d, long=%lld, bool=%d, float=%f, double=%f, string=%s",
            in_anInt, (long long)in_aLong, in_aBoolean, in_aFloat, in_aDouble, in_aString.c_str());
...
{
    LOGD("[MyService] [cpp] complexType: int=%d, long=%lld, bool=%d, float=%f, double=%lf, string=%s",
         in_aComplexObject.i_Int,
         (long long)in_aComplexObject.l_Long,
    ...
    snprintf(strBuf, 1024, "int=%d, long=%lld, bool=%d, float=%f, double=%lf, string=%s",
            in_aComplexObject.i_Int,
            (long long)in_aComplexObject.l_Long,
            in_aComplexObject.b_Boolean,
            in_aComplexObject.f_Float,
